...
using ctre::phoenix::motorcontrol::ControlMode;
    ...
    void TurnToAngle::Initialize(){
        ...
        DebugOutF("TurnToAngle Initialize starting at " + std::to_string(Robot::GetRobot()->GetNavX().GetYaw()) +
    ...
    void TurnToAngle::Execute(){
        ...
        // m_DriveTrain.GetFrontL().Set(ControlMode::PercentOutput, m_MaxSpeed * (m_FinalTicks[0] > m_InitialTicks[0]) ? 1 : -1);
	    // m_DriveTrain.GetFrontR().Set(ControlMode::PercentOutput, m_MaxSpeed * (m_FinalTicks[1] > m_InitialTicks[1]) ? 1 : -1);
	    // m_DriveTrain.GetBackL().Set(ControlMode::PercentOutput, m_MaxSpeed * (m_FinalTicks[2] > m_InitialTicks[2]) ? 1 : -1);
	    // m_DriveTrain.GetBackR().Set(ControlMode::PercentOutput, m_MaxSpeed * (m_FinalTicks[3] > m_InitialTicks[3]) ? 1 : -1);
    }
    ...
    bool TurnToAngle::IsFinished(){
        return 
            ...
            (abs(Robot::GetRobot()->GetNavX().GetYaw() - m_TargetAngle) <= 1);
    }
